...
var setFocusStyle = function setFocusStyle($button, bgColor) {
  //var rgbColor = _hexToRgb.hexToRgb(bgColor); //No longer used
  //$button.style.boxShadow = '0 0 2px rgba(255, 255, 255, 0.8), inset 0 0 0 1px rgba(0, 0, 0, 0.05)'; //Disabled
};
...
// Loading animation
"<div class=\"la-ball-fall\">\n          <div></div>\n          <div></div>\n          <div></div>\n        </div>\n      </div><br/><div class=\"sa-cancel-button-container\">\n        <button class=\"cancel\" tabIndex=\"2\"></button></div>\n    </div>" +
