...
(function (global, factory) {
  ...
  var setParameters = function(params) {
    ...
    if (params.buttonsStyling) {
      ...
      //$cancelBtn.style.backgroundColor = params.cancelButtonColor; //Disabled
    }
          ...
          case 'mouseup':
            if (params.buttonsStyling) {
              if (targetedConfirm) {
                ...
                //cancelBtn.style.backgroundColor = colorLuminance(params.cancelButtonColor, -0.1); //Disabled
              }
            }
            break;
          case 'mouseout':
          ...
          case 'mousedown':
            if (params.buttonsStyling) {
              if (targetedConfirm) {
                ...
                //cancelBtn.style.backgroundColor = colorLuminance(params.cancelButtonColor, -0.2); //Disabled
              }
            }
            break;
          case 'click':
