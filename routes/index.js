...
var db = low('db.json', {storage: fileAsync }),
	...
	_ = require('lodash'),
	slug = require('slugg'),
	stripe = require("stripe")("sk_test_Lw1dC9XzBrEVHnKMhITJkG0K"); //See your keys here: https://dashboard.stripe.com/account/apikeys
...
router.post('/stripe', function (req, res, next) {
	...
	if (_.isUndefined(token)) return res.json({ success: false, err: "Undefined token" });
